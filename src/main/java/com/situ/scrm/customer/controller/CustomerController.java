package com.situ.scrm.customer.controller;
...
import com.situ.scrm.customer.domain.Customer;
import com.situ.scrm.customer.service.CustomerService;
...
public class CustomerController implements Serializable {
	...
	private static final String PAGE_CUSTOMER_INDEX = "customer/customer_index";
	private static final String PAGE_CUSTOMER_ADD_EDIT = "customer/customer_add_edit";
    @Autowired
	...
	public ModelAndView goAddOrEdit(ModelAndView modelAndView) {
		...
		modelAndView.addObject("dictionaryList", dictionariesService.DictionariesList());
		return modelAndView;
	}
