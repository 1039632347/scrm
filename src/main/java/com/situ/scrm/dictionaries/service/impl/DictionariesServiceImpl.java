package com.situ.scrm.dictionaries.service.impl;
...
import com.situ.scrm.dictionaries.dao.DictionariesDao;
...
public class DictionariesServiceImpl implements  DictionariesService {
	 ...
	 */
	@Override
	public Integer doDeleteDict(Long rowId) {
	 ...
	 */
	@Override
	public Dictionaries getAllDicById(Long rowId) {
		return dictionariesDao.get(rowId);
	}
