 ...
 */
package com.situ.scrm.user.controller;
...
public class UserController implements Serializable {
	...
	private static final String PAGE_USER_ADD_EDIT = "user/user_add_edit";
	private static final String USER_OPTION = "user/user_option";
	@Autowired
